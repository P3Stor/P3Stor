...
xst -ifn xst.scr
move clk_200_400_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clk_200_400.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_200_400.ucf clk_200_400_exdes

echo 'Running map'
map -timing -pr b clk_200_400_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk_200_400_exdes -w routed.ncd routed.v
cd ..
